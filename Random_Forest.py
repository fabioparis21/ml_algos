'''
Modello di foresta casuale (riparto da Decision_Tree.py) (LINE 56)
...
#Creazione della foresta casuale!
#Di base sklearn imposta 10 alberi per la foresta, possiamo però modificare il parametro
...
Y_pred_train_proba = forest.predict_proba(X_train)
